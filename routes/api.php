...
/*Route::get('api/images/filter/{category_id}', ['uses' => 'API\ImageController@filter', 'as' => 'api/images/create/{category_id}']);
Route::get('api/images/show/{image_id}', ['uses' => 'API\ImageController@show', 'as' => 'api/images/show/{image_id}']);
Route::put('api/images/edit', ['uses' => 'API\ImageController@edit', 'as' => 'api/images/edit']);
Route::post('api/images/create', ['uses' => 'API\ImageController@create', 'as' => 'api/images/create']);*/
